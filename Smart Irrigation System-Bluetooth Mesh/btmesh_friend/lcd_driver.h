...
#define LCD_ROW_MOISTURE_LEVEL  		 5    /* 5th row, lightness level */
#define LCD_ROW_SPRINKLER_STATUS  		 6    /* 6th row, color temperature */
#define LCD_ROW_OOB_PASS      			 7    /* 7th row, delta UV */
